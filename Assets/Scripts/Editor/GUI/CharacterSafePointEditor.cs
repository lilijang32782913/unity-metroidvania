...
namespace MetroidvaniaEditor.CharacterSafePoints {
    ...
    public class CharacterSafePointEditor : Editor {
        ...
        private void OnSceneGUI() {
            ...
            var fmh_36_85_639121105548261891 = Quaternion.identity; _position.vector2Value = Handles.FreeMoveHandle(_position.vector2Value, 0.25f, Vector3.zero, Handles.DotHandleCap);
